...
<div class="section" id="myPage">
	<div class="container">
		<div>
			<form action="./updateAdminForID.be" method="post" style="width:350px; margin-left: auto; margin-right: auto;">
				<p class="mem_title">회원 정보</p>
				...
				<ul>
					...
					<li class="btnForm">
						...
						<button type="submit"><a>수정완료<a></a></button>
			<!-- 			<br><input type="submit" value="회원가입"> -->
					<input type="button" onclick="location.href='./updateUserListDisplay.be';" value="관리자페이지"> 
